...
cleanfigure();
matlab2tikz('filename',sprintf('figures/kx_int_2500.tex'),'showInfo', false)

%% Save data for use in other files

save data/kx_int_2500.mat % Save data to plot the branch cuts
save('data/fields_2500.mat', 'H', 'x')              % Save H and x for plotting along SPP

%% Plot the integrands

figure(2)
integrand1 = G_c1.*exp(-1i*1e2*kx_c1);
loglog(imag(kx_c1), real(G_c1),'LineWidth',1.4,'Color','black')

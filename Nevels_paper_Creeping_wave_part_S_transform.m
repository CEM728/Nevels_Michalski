...
cleanfigure();
matlab2tikz('filename',sprintf('nevels_michalski_decay_plot_S_trans_.tex'),'showInfo', false)
%%

save nevels_michalski_creeping_S_transform.mat % Save data to plot the branch cuts
save('test_S_transform.mat', 'Creep', 'x')              % Save H and x for plotting along SPP
